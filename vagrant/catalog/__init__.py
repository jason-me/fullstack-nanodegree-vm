...
def fbconnect():
    ...
    app_id = json.loads(open('/var/www/catalog/catalog/vagrant/catalog/fb_client_secrets.json', 'r').read())[
        'web']['app_id']
    app_secret = json.loads(
        open('/var/www/catalog/catalog/vagrant/catalog/fb_client_secrets.json', 'r').read())['web']['app_secret']
...
def gconnect():
    ...
    try:
        ...
        oauth_flow = flow_from_clientsecrets('/var/www/catalog/catalog/vagrant/catalog/client_secrets.json', scope='')
